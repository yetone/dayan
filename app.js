...
(function(){
  var fs, commander, request, nodeStatic, http, url, utils, file, server, DyService, dyService, handlerList, toString$ = {}.toString;
  fs = require('fs');
  ...
  DyService = (function(){
    ...
    prototype.registerHandler = function(router, url, method){
      ...
      for (i$ = 0, len$ = arr.length; i$ < len$; ++i$) {
        ...
        this.handlerList.push([item.router, fn1$(item), methodList]);
      }
      function fn$(e){
    ...
    prototype.route = function(req, resp){
      var self, pathname, i$, ref$, len$, item, re;
      self = this;
